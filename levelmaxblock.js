!function(){function f(){var a=document.createElement("div");a.id="levelmaxblock";a.innerHTML='<div class="inner"> <div class="header"> <h2>Reklam Engelleyici Algılandı</h2> </div> <div class="isi"> <p>Lütfen reklam engelleyicinizi devre dışı bırakın</p> <div class="tombol"><button class="1 active">Adblock</button><button class="2">Adblock Plus</button></div> <div class="caranya"> <div class="1 active"> <ol> <li>
 <div class="content">
      <div class="warn-icon">
